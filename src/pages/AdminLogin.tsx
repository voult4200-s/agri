          ...
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-blue-200 dark:border-blue-900">
              ...
              <ul className="text-sm space-y-2 text-gray-700 dark:text-gray-300">
                <li>✓ Complete Admin Control System</li>
                <li>✓ Shop Order Management</li>
                <li>✓ Cold Storage Booking & Sales</li>
                <li>✓ Farmer Activity Tracking</li>
                <li>✓ User Block/Suspend/Delete</li>
                <li>✓ All data in LocalStorage</li>
              </ul>
            </div>
          </div>
          ...
          <div>
            <Card className="border-0 shadow-lg">
              <CardHeader className="bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-t-lg">
                ...
                <CardDescription className="text-green-100">Select your role to login</CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  <TabsList className="grid w-full grid-cols-3 mb-6">
                    ...
                    <TabsTrigger value="cold">Cold Store</TabsTrigger>
                  </TabsList>
                ...
                <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950 rounded border border-blue-200 dark:border-blue-800">
                  <p className="text-xs text-blue-700 dark:text-blue-300 flex gap-2">
                    ...
                    <span>
                      This is a demo system. All data is stored in localStorage. Use the demo credentials provided above.
                    </span>
                  </p>
                </div>
              </CardContent>
